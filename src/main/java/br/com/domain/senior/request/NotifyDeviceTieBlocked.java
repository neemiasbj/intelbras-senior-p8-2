...
public class NotifyDeviceTieBlocked extends HeaderMessage {
    ...
    public NotifyDeviceTieBlocked(byte messageNumber, int deviceID, Date eventDate, short gmt, DeviceCommType generatedOnline, byte tie,
                                  boolean active) {
        super(messageNumber, (byte) 3, (byte) 3);
